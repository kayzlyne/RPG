...
public class Mission2 {
    public static void mission2 (PlayerCharacter player) {
        ...
        int choice = -1;
        /* making this a comment muna while getScanner isn't up yet -ef
        ...
        System.out.println("\nScribe: If you truly wish to stand against them, then steel yourself. " +
                "It is not named the Dark Forest for no reason. The forest is alive. And it does not forgive trespassers easily.");
