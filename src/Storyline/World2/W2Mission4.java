...
public class W2Mission4 {
    public static void w2mission4(PlayerCharacter player) {
        ...
        System.out.println("Tambalan: The Aswang’s thirst for blood waits for no one.\nAnd the blade’s blessing will shield her more than my herbs ever could.\nGo together, but listen well. Their lair is hidden. You will not find it by sight alone.\nFollow the signs of their gluttony. They linger where the air itself rots.\nBeware their trickery, for the farther away they sound, the closer they actually are.\n");
        sc.nextLine();
