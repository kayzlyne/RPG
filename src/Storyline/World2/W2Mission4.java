...
public class W2Mission4 {
    public static void w2mission4(PlayerCharacter player) {
        ...
        System.out.println();
        System.out.println("=================================================");
        System.out.println("    MISSION 4:  A SHRINE OF ENTRAILS AND BONE ");
        System.out.println("=================================================");
        System.out.println();
        ...
        System.out.println("Tambalan: The Aswang’s thirst for blood waits for no one. And the blade’s blessing will shield her more than my herbs ever could. Go together, but listen well. Their lair is hidden. You will not find it by sight alone. Follow the signs of their gluttony. They linger where the air itself rots. Beware their trickery, for the farther away they sound, the closer they actually are.\n");
        sc.nextLine();
