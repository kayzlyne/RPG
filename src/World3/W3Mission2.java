...
public class W3Mission2 {
    public static void w3mission2(PlayerCharacter player){
        ...
        System.out.println("You: “Origin of the Babaylans…” What could it mean? Are we supposed to find where their power began?");
        ...
        System.out.println("Kheila: Beneath the roots of an ancient Balete near the Valley of Mist. But beware, for the Blade’s guardian, the Tagapangalaga, demands something even the goddess cannot give: a sacrifice of self.");
        System.out.println("Andrea: A sacrifice of self? What does that even mean?");
